...
```{r, message=FALSE,results='hide'}
N98RIP_genes <- read_delim("C:/Users/Juliana/Desktop/extra view/Nup98-DBPs_extraview/RIPseq/GSE67963-RIP N98/GSE67963_significance_calls_genes.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
```

```{r}
#Separate only nup98 data
N98RIP_genes <- N98RIP_genes[N98RIP_genes$sample_2 == "nup98",]
